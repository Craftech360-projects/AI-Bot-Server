...
personality_data = [
    ...
    {"question": "value - we enable for our clients using gen ai", "response": "Gen AI COE enable Values across Client Business areas for example: Increase revenue generation through hyper personalized marketing for target customers through Content Generation, Increase pace of new product & service development and speedier GTM, Reduce cost around 30% or higher through automating job functions & undertaking job substitutions, Uncover new ideas, insights, questions and generally unleash creativity and much more"},
